...
public class MutableLong extends Number implements Comparable<MutableLong>, Mutable<Number> {
	...
	/** The mutable value. */
	private /*@ spec_public @*/ long value;
	 ...
	 */
	//@ requires value != null;
	//@ signals (NumberFormatException e);
	 ...
	 * @throws NullPointerException if the object is null
	 */
	//@ also requires value != null;
	//@ also signals (NullPointerException e);
	@Override
	 ...
	 * @since 2.2
	 */
	//mt estranho isso aqui //@ requires operand != null;
	...
	//@ requires operand != null;
	//@ signals (NullPointerException e);
	//@ ensures \result ==	value - operand.longValue();
	 ...
	 */
	//@ also ensures \typeof(\result) == \type(long);
	@Override
	 ...
	 */
	//@ also ensures \typeof(\result) == \type(float);
	@Override
	 ...
	 */
	//@ also ensures \typeof(\result) == \type(double);
	@Override
	 ...
	 */
	//@ also requires \typeof(obj) == \type(Object);
	@Override
	 ...
	 */
	//@ also requires other != null && \typeof(other) == \type(MutableLong);
	//@ also ensures \result == 0 || \result == 1 || \result == -1;
	@Override
